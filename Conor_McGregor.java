public class Conor_McGregor extends Moderne{//Combattant représentant l'art martial : MMA
	...
	public String Attaque_spe(Fighter f){ // f désigne son adversaire, cette méthode permet de simuler des attaques et d'enlever des pv à l'adversaire
		...
		return super.Attaque_spe(f)+"McGregor s'avance et attaque avec son Spinning Back Kick";//Technique de pied arrière en rotation qui consiste à avancer avec la jambe de tête, pivoter et tourner pour lancer la jambe arrière dans le corps de l'adversaire.	
	}
